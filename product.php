...
<body style="background: whitesmoke;">
    <div class="w3-panel w3-blue-grey"><center><h1 class="w3-jumbo w3-text-white"><div class="newh1">STOCK MANAGEMENT SYSTERM</div></h1></center></div>
    <div class="row">
        <div class="col-1"></div>
            ...
            <?php
                if(isset($_POST['add'])){
                    ...
                    if(preg_match("/^[a-zA-Z]*$/",$pname)){
                        ...
                        ?>
                        <script>
                            alert("Sorry!! Productname must only contain Letters");
                        </script>
                        <?php
                    }
                }
        ...
        <?php
            ...
            while($row=mysqli_fetch_array($sel)){
                ...
                <tr>
                    ...
                    <td><center><button onclick="del(<?=$ppid?>)" class="delete">Delete</button></center></td>
                    <script>
                        function del(x,z){
