...
<body style="background: whitesmoke;">
        ...
        <div class="w3-modal-content" id="mcont" style="background: transparent;">
            <div class="w3-round-xlarge w3-blue-grey">
                <center>
                    <form action="#" class="w-75" method="post">
                        ...
                        <center>
                            <h1 class="w3-xxlarge">Stock in</h1>
                            <div class="">
            ...
            <?php
                if(isset($_POST['add'])){
                    ...
                    $cdate=date('Y-m-d');
                    if($date<=$cdate){
                        $ins=mysqli_query($conn,"INSERT into stock_in values(null,$pidd,'$date','$qty','$uprice',$qty*$uprice)");
                        if($ins){
                            header("location: stockin.php");
                        }else{
                            ?>
    ...
    <button class="btn w3-teal" onclick="$('#modal').show()" id="addd">Stockin</button>
    <br><br>
        ...
        <?php
            ...
            while($row=mysqli_fetch_array($sel)){
                ...
                <tr>
                    ...
                    <td><center><a href="stockin.php?out=<?=$row['St_id']?>"><i class="fas fa-pen w3-text-blue"></i>OUT</a></center></td>
                    <script>
                        function del(x){
    ...
    <div class="w3-display-left w3-round-xlarge w3-blue-grey w-25" style="margin-top: 5%;" id="out">
        <center>
            <form action="#" class="w-75" method="post">
                <!-- <div class="w3-display-topright"><span onclick="$('#modal').hide()" class="w3-jumbo w3-text-red">&times;</span></div> -->
                <center>
                    <h1 class="w3-xxlarge">Remove some <?=$fezz['Product_name']?></h1>
                    <div class="">
                        <label for="">Product name</label><br>
                        <select name="pname" class="form-control" required>
                    ...
                    <div class="">
                        <label for="">Quantity</label><br>
                        <input type="number" min="0" max="<?=$fezz['Quantity']?>" name="qty" class="form-control" required>
                    </div><br>
                    <div class="">
                    <div class="">
                    <input type="submit" name="outt" value="Remove" class="btn btn-success w-50">
                    <a href="product.php" class="btn btn-danger w-25">Cancel</a>
                    <br>
                </center>
            </form>
            ...
            <?php
                if(isset($_POST['outt'])){
                    ...
                    $cdate=date('Y-m-d');
                    if($date>=$cdate){
                        $up=mysqli_query($conn,$v="UPDATE stock_in set Quantity=Quantity-$qty,Total_price=$qty*Unit_price where St_id=$ppid");
